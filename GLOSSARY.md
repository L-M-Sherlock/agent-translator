...
本术语表用于统一本仓库的翻译用词（尤其是间隔重复系统语境下的术语）。如无特殊说明，保留原文专有名词、链接与 Markdown 标记不变。

| English | 中文译法 | 说明 |
| --- | --- | --- |
| Mnemonic medium | 助记媒介 | 固定译法；作为专有概念使用时首字母大写与否按原文。 |
...
| raw (Japanese learning materials context) | 生肉 | 指未翻译/未字幕的原始材料；常与「熟肉」（翻译/字幕版）对照。 |
