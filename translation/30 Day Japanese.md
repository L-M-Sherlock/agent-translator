...
但一切都从 raw listening 开始：先去听，然后努力让听变得可理解。
...
`Alt`+`\``（反引号，1 左边的那个键）：在直接输入字母与假名输入之间切换，比如从 kana 切到 かな。如果任务栏上的符号是 A，你输入 "kana" 就会得到 "kana"；如果符号是 あ，就会变成「かな」。
...
A：这样你就能做「原始阅读练习」（raw reading practice）。
...
日语字幕：优点：学新词、练阅读  
缺点：不能训练 raw 听力，你可能会忽略音频里实际说了什么

无字幕（raw）：  
优点：训练 raw 听力，也可能帮助口语能力；你会注意到的东西比只看日语字幕更多  
缺点：你不懂的词就是不懂。
...
对，你可以阅读/带日语字幕观看/raw 听力/subtitle tutor。
...
你的**raw（无字幕）听力练习**会帮助你建立一种「语言实际听起来是什么样」的心理模型。这有很多好处：最主要的是有助于形成更好的口音，也能让你更容易听出你已经认识的词。听力不像阅读那样清晰，它可能很快、很难跟上。通过适应 raw 听力，你可以训练自己更好地捕捉这些不清晰的部分。

当你的日语水平进阶到能理解 raw 听力沉浸时，大量 raw 听力就是你走向流利的唯一道路。
...
-   Anki
-   你的语法学习
-   「沉浸」＝（读那部漫画、raw 听动画、subtitle tutor、被动聆听、日语字幕）
